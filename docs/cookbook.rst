...
have Tasty Pie use these tokens to authenticate users to the API. `Follow this tutorial <http://ianalexandr.com/blog/building-a-true-oauth-20-api-with-django-and-tasty-pie.html>`_ and `use this custom authentication class <https://github.com/ianalexander/django-oauth2-bmga>`_ to enable
...
.. testcode::
    ...
    from bmga.resources import ModelResource, Resource
...
easily extend the :meth:`~bmga.resources.Resource.dehydrate` method to
...
with an ``bmga.Api`` instance, as below:
...
.. testcode::
    ...
    from bmga.utils import trailing_slash
...
.. testcode::
    ...
    # myapp/api/resources.py
    from bmga.authentication import ApiKeyAuthentication
...
where BoxMeAPI uses underscore syntax, which can lead to "ugly" looking
...
By default, BoxMeAPI outputs JSON with no indentation or newlines (equivalent to calling
...
.. testcode::
    ...
    from bmga.resources import csrf_exempt
...
.. testcode::
    ...
    from bmga.admin import ApiKeyInline
