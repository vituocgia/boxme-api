...
BoxMeAPI provides some basic facilities that build on top of `Django's testing`_
...
An example usage might look like::
    ...
    from bmga.test import ResourceTestCaseMixin
    from entries.models import Entry
...
things that read off the ``GET`` params. Example::
    ...
    from bmga.test import TestApiClient
