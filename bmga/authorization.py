...
from bmga.exceptions import Unauthorized
from bmga.compat import get_module_name
...
class Authorization(object):
    ...
    def create_list(self, object_list, bundle):
        """
        Unimplemented, as BoxMeAPI never creates entire new lists, but
        present for consistency & possible extension.
        """
        raise NotImplementedError("BoxMeAPI has no way to determine if all objects should be allowed to be created.")
