...
from bmga.exceptions import ApiFieldError, NotFound
from bmga.utils import dict_strip_unicode_keys, make_aware
...
class RelatedField(ApiField):
    ...
    def to_class(self):
        ...
        if '.' in self.to:
            ...
            raise ImportError("BoxMeAPI requires a Python-style path (<module.module.Class>) to lazy load related resources. Only given '%s'." % self.to)
    ...
    def contribute_to_class(self, cls, name):
        ...
        if not self.related_name:
            ...
            if isinstance(related_field, ReverseOneToOneDescriptor):
                ...
                # and https://github.com/vituocgia/boxme-api/issues/566
