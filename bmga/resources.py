...
from bmga.authorization import ReadOnlyAuthorization
from bmga.bundle import Bundle
from bmga.cache import NoCache
from bmga.compat import NoReverseMatch, reverse, Resolver404, get_script_prefix
from bmga.constants import ALL, ALL_WITH_RELATIONS
from bmga.exceptions import (
...
from bmga import http
from bmga.paginator import Paginator
from bmga.serializers import Serializer
from bmga.throttle import BaseThrottle
from bmga.utils import (
    dict_strip_unicode_keys, is_valid_jsonp_callback_value, string_to_python,
    trailing_slash,
)
from bmga.utils.mime import determine_format, build_content_type
from bmga.validation import Validation
from bmga.compat import get_module_name, atomic_decorator
...
class DeclarativeMetaclass(type):
    def __new__(cls, name, bases, attrs):
        ...
        for field_name, obj in attrs.copy().items():
            ...
            # which can break down if BoxMeAPI is re-namespaced as something
            # else.
...
class Resource(six.with_metaclass(DeclarativeMetaclass)):
    ...
    def _handle_500(self, request, exception):
        ...
        if response_class.status_code >= 500:
            log = logging.getLogger('django.request.bmga')
                ...
                if value is not None or field_object.null:
                    ...
                    if not field_object.is_related:
                        ...
                        if value is not None:
                            ...
                            # which BoxMeAPI was relying on.  To fix this, we store value.obj to
