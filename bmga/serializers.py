...
from bmga.exceptions import BadRequest, UnsupportedSerializationFormat,\
    UnsupportedDeserializationFormat
from bmga.utils import format_datetime, format_date, format_time,\
    make_naive
...
# Ugh & blah.
# So doing a regular dump is generally fine, since BoxMeAPI doesn't usually
...
if yaml is not None:
    ...
    class BoxmeConstructor(SafeConstructor):
    ...
    BoxmeConstructor.add_constructor(
        u'tag:yaml.org,2002:python/unicode',
        BoxmeConstructor.construct_yaml_unicode_dammit
    )

    class BoxmeLoader(Reader, Scanner, Parser, Composer,
            BoxmeConstructor, Resolver):
        def __init__(self, stream):
            Reader.__init__(self, stream)
            Scanner.__init__(self)
            Parser.__init__(self)
            Composer.__init__(self)
            BoxmeConstructor.__init__(self)
...
class Serializer(object):
    ...
    def __init__(self, formats=None, content_types=None, datetime_formatting=None):
        ...
        # https://github.com/vituocgia/boxme-api/issues#issue/12 for
        # more information.
    ...
    def from_yaml(self, content):
        ...
        return yaml.load(content, Loader=BoxmeLoader)
