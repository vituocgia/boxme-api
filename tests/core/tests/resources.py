...
from bmga import fields, http
from bmga.compat import is_authenticated
from bmga.paginator import Paginator
from bmga.resources import (
...
from bmga.utils import aware_datetime, make_naive
from bmga.validation import FormValidation
...
class DetailedNoteResourceWithHydrate(DetailedNoteResource):
    def hydrate(self, bundle):
        bundle.data['user'] = bundle.request.user  # This should fail using BoxMeAPI 0.9.11 if triggered in patch_list
        return bundle
...
class ModelResourceTestCase(TestCase):
    ...
    @patch('bmga.resources.ModelResource.obj_get_list', side_effect=IOError)
...
class Handle500TestCase(TestCase):
    ...
    @patch('bmga.resources.traceback')
