...
from bmga.authentication import Authentication, BasicAuthentication,\
    ApiKeyAuthentication, SessionAuthentication, DigestAuthentication,\
    OAuthAuthentication, MultiAuthentication
from bmga.http import HttpUnauthorized
from bmga.models import ApiKey, create_api_key


# Be tricky.
from bmga.authentication import python_digest, oauth2, oauth_provider
...
class BasicAuthenticationTestCase(TestCase):
    ...
    def test_is_authenticated(self):
        ...
        self.assertEqual(auth.is_authenticated(request)['WWW-Authenticate'], 'Basic Realm="boxme-api"')
...
class DigestAuthenticationTestCase(TestCase):
    ...
    def test_is_authenticated(self):
        ...
        self.assertEqual(auth_request['WWW-Authenticate'].find(' realm="boxme-api"') > 0, True)
